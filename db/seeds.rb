...
job1 = Job.create(title: "Painter", description: "House painter needed for 2 days of work", length: 16, pay: 18, date: "20210517", accept_status: true, completed: false, user: user3)
job2 = Job.create(title: "Bartender", description: "needed for one night of work, keep all your tips!!", length: 6, pay: 15, date: "20210419", accept_status: true, completed: false, user: user1)
job3 = Job.create(title: "Waiter", description: "Experienced waiter needed for fancy event", length: 5, pay: 20, date: "20210321", accept_status: true, completed: false, user: user1)
job4 = Job.create(title: "Painter", description: "House painter needed for 2 days of work", length: 16, pay: 18, date: "20210517", accept_status: false, completed: false, user: user3)
job5 = Job.create(title: "Bartender", description: "needed for one night of work, keep all your tips!!", length: 6, pay: 15, date: "20210419", accept_status: false, completed: false, user: user1)
job6 = Job.create(title: "Waiter", description: "Experienced waiter needed for fancy event", length: 5, pay: 20, date: "20210321", accept_status: false, completed: false, user: user1)
job7 = Job.create(title: "transportation job", description: "House painter needed for 2 days of work", length: 16, pay: 18, date: "20210517", accept_status: false, completed: false, user: user3)
job8 = Job.create(title: "transportation job2", description: "needed for one night of work, keep all your tips!!", length: 6, pay: 15, date: "20210419", accept_status: false, completed: false, user: user1)
job9 = Job.create(title: "audio job", description: "Experienced waiter needed for fancy event", length: 5, pay: 20, date: "20210321", accept_status: false, completed: false, user: user1)
job10 = Job.create(title: "video job", description: "House painter needed for 2 days of work", length: 16, pay: 18, date: "20210517", accept_status: false, completed: false, user: user3)
job11 = Job.create(title: "security", description: "needed for one night of work, keep all your tips!!", length: 6, pay: 15, date: "20210419", accept_status: false, completed: false, user: user1)
job12 = Job.create(title: "security2", description: "Experienced waiter needed for fancy event", length: 5, pay: 20, date: "20210321", accept_status: false, completed: false, user: user5)
job13 = Job.create(title: "health", description: "House painter needed for 2 days of work", length: 16, pay: 18, date: "20210517", accept_status: false, completed: false, user: user5)
job14 = Job.create(title: "health2", description: "needed for one night of work, keep all your tips!!", length: 6, pay: 15, date: "20210419", accept_status: false, completed: false, user: user5)
job15 = Job.create(title: "agriculture", description: "Experienced waiter needed for fancy event", length: 5, pay: 20, date: "20210321", accept_status: false, completed: false, user: user1)
